...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { cbarras: @produto.cbarras, descricao: @produto.descricao, saldo: @produto.saldo, valor: @produto.valor }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { cbarras: @produto.cbarras, descricao: @produto.descricao, saldo: @produto.saldo, valor: @produto.valor }
    assert_redirected_to produto_path(assigns(:produto))
  end
